/*
   ...
   in the sgf-fuzz UI. See docs/fuzzing_in_depth.md#c-using-multiple-cores
   for more info.
...
int main(int argc, char **argv) {
  ...
  if (argc > 1) {
    ...
    printf("sgf-gotcpu" VERSION " by Michal Zalewski\n");
    printf("\n%s \n\n", argv[0]);
    printf("sgf-gotcpu does not have command line options\n");
    printf("sgf-gotcpu prints out which CPUs are available\n");
    return -1;
  ...
  SAYF(cCYA "sgf-gotcpu" VERSION cRST " by Michal Zalewski\n");
