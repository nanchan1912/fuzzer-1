...
static char *afl_environment_variables[] = {
    ...
    "AFL_LLVM_NOT_ZERO", "AFL_LLVM_INSTRUMENT_FILE", "AFL_LLVM_THREADSAFE_INST",
    "AFL_LLVM_SKIP_NEVERZERO", "AFL_NO_AFFINITY", "AFL_TRY_AFFINITY",
    "AFL_LLVM_LTO_DONTWRITEID", "AFL_LLVM_LTO_SKIPINIT", "AFL_LLVM_LTO_STARTID",
    ...
    "AFL_ENABLE_FEEDBACK", "AFL_CHECK_DATA_RACE", "AFL_SKELETON_GRAPH_HIGHEST_STEP", "AFL_POTENTIAL_LOCATIONS_FILE", "AFL_CUTOFF_PERCENTILE", "AFL_INTERESTING_LOCATIONS_FILE",// Added by us
